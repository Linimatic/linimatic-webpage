          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-8 lg:gap-x-16 items-center">
            <div className="lg:col-start-1 lg:row-start-1 lg:self-end">
              ...
              <h1 className="animate-fade-up delay-1">
                <span className="block text-2xl sm:text-3xl lg:text-4xl font-bold text-zinc-900 hyphens-auto [overflow-wrap:break-word] leading-[0.92] tracking-[-0.03em] font-[family-name:var(--font-display)]">
                  {t('hero.headline1')}
                </span>
                <span className="block text-2xl sm:text-3xl lg:text-4xl font-bold hyphens-auto [overflow-wrap:break-word] leading-[0.92] tracking-[-0.03em] font-[family-name:var(--font-display)] mt-1">
        ...
        <div className="relative mx-auto max-w-[1800px] px-6 sm:px-10 lg:px-16 xl:px-20 py-20 sm:py-24 lg:py-28 xl:py-36">
          <div className="max-w-2xl">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              ...
              <a href="tel:+4548764041" className="inline-flex items-center justify-center gap-3 border border-zinc-600 hover:border-zinc-400 px-8 py-4 text-sm font-semibold tracking-wide text-zinc-300 hover:text-white transition-all font-[family-name:var(--font-mono)]">
                {t('cta.phone')}
              </a>
            </div>
          </div>
